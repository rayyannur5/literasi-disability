      ...
      floatingActionButton: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Text('Pilih Jenis Buku', style: Style.title,),
            Padding(
              padding: const EdgeInsets.symmetric(horizontal: 20),
        ...
        child: ListView(
            ...
            children: [
              ...
              Column(
                children: [
                  Spacer(flex: 2,),
                  CustomCard(imagePath: 'assets/image/icon_dongeng.png', title: 'Cerita Rakyat', onTap: (){}),
                  Spacer(),
                ],
              ),
              SizedBox(width: size.width/15),
              Column(
                children: [
                  Spacer(flex: 2,),
                  CustomCard(imagePath: 'assets/image/icon_dongeng.png', title: 'Fabel', onTap: (){}),
                  Spacer(),
                ],
              )
            ],
